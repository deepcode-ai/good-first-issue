  ...
  >
    ...
    <div class="pt-6">
      <a
        ...
        href="https://github.com/deepcode-ai/good-first-issue#adding-a-new-project"
        target="_blank"
    ...
    <div class="text-sm pt-6">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        href="https://deepcode.khulnasoft.com?ref=gfi"
      >
        <img style="width: 14px" src="/social/heart.svg" alt="Heart" />
        <span class="ml-2"
          >A
          <span class="inline hover:underline text-juniper" title="Visit DeepCode website"
            >DeepCode</span
          >
          initative</span
        >
